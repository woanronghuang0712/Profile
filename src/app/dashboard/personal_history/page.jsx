...
const title_theme = `${angkor.className} pb-2 mt-3 p-2 text-rose-500 text-3xl underline hover:decoration-dotted hover:underline-offset-4 underline-offset-1 duration-300`;
